class Cloudsmith < Formula
  ...
  url "https://github.com/cloudsmith-io/cloudsmith-cli/archive/refs/tags/v1.8.1.tar.gz"
  sha256 "c78c31ae4820620f382d8882ef0608216b43c5875fe30195a67d8811506db6d4"
  license "Apache-2.0"

  # `click-spinner` is not compatible with python 3.13
  ...
  test do
    ...
    assert_match "Getting list of distributions ... OK", shell_output("#{bin}/cloudsmith list distros")
  end
end
